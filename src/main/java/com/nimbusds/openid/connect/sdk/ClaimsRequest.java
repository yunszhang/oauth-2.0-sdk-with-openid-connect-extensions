...
public class ClaimsRequest {
    ...
    public static class Entry {
         ...
         *                              If set, then the {@code value} parameter
         *                              must not be set.
         * @param additionalInformation Optional additional information about the
         *                              requested Claims.
         */
        private Entry(final String claimName, final ClaimRequirement requirement, final LangTag langTag,
        ...
        /**
         * Get the optional additionalInformation for the claim
         *
         * @return The additonalInformation, {@code null} if not specified
         */
     ...
     * @param value       The expected claim value, {@code null} if not
     *                    specified.
	 * @param additionalInformation The additional information for this claim,
