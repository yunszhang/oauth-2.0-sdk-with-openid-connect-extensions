...
public interface StringListOperation extends PolicyOperation {
	 ...
	 *
	 * @param value The string list, {@code null} if not specified.
	 *
	 * @return The resulting string list (unmodifiable).
	 *
	 * @throws PolicyViolationException On a policy violation.
	 */
	List<String> apply(final List<String> value) throws PolicyViolationException;
}
